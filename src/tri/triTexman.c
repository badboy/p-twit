...
{
	float b = ((float)(c1 & 0xFF) - (float)(c2 & 0xFF));
	float g = ((float)((c1 >> 8) & 0xFF) - (float)((c2 >> 8) & 0xFF));
	float r = ((float)((c1 >> 16) & 0xFF) - (float)((c2 >> 16) & 0xFF));
...
{
	float b = ((float)(c1 & 0xF) - (float)(c2 & 0xF));
	float g = ((float)((c1 >> 4) & 0xF) - (float)((c2 >> 4) & 0xF));
	float r = ((float)((c1 >> 8) & 0xF) - (float)((c2 >> 8) & 0xF));
...
{
	float b = ((float)(c1 & 0x1F) - (float)(c2 & 0x1F));
	float g = ((float)((c1 >> 5) & 0x1F) - (float)((c2 >> 5) & 0x1F));
	float r = ((float)((c1 >> 10) & 0x1F) - (float)((c2 >> 10) & 0x1F));
...
{
	float b = ((float)(c1 & 0x1F) - (float)(c2 & 0x1F));
	float g = ((float)((c1 >> 6) & 0x3F) - (float)((c2 >> 6) & 0x3F));
	float r = ((float)((c1 >> 11) & 0x1F) - (float)((c2 >> 11) & 0x1F));
	return (r*r + g*g + b*b);
}
